...
object ContentUriHelper {
    ...
    fun getFileExtensionFromUri(fileUri: Uri): String? {
        val mimeType = Collect.getApplication().contentResolver.getType(fileUri)
        ...
        if (extension == null || extension.isEmpty()) {
            Collect.getApplication().contentResolver.query(fileUri, null, null, null, null).use { cursor ->
